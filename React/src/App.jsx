...
const App = () => {
  ...
  const [debouncedSearchTerm, setDebouncedSearchTerm] = useState("second");
  ...
  return (
    <main>
      <div className="pattern max-w-[100%]" />
      <div className="wrapper">
        ...
        {trendingIsLoading ? (
          ...
          <p className="text-red-500 my-4">{trendingMoviesErrorMessage}</p>
        ) : (
